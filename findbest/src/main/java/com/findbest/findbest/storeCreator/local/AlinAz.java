...
public class AlinAz extends LocalStore {
    ...
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.ut2-pb__title";
    private final static String PRODUCT_PICTURE_KEY = "img.ty-pict";



    public AlinAz(List<String> links){
        super("AlinAz");

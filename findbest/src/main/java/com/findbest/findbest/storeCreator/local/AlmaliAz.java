...
public class AlmaliAz extends LocalStore {

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "p.price ins span bdi";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product_title";
    private final static String PRODUCT_PICTURE_KEY = ".woocommerce-product-gallery__image a img";



    public AlmaliAz(List<String> links){
        super("AlmaliAz");

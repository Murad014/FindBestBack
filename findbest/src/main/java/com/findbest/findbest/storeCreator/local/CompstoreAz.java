...
public class CompstoreAz extends LocalStore {

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span#optionPrice";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.detailed-title";
    private final static String PRODUCT_PICTURE_KEY = "div.detailed-img a";
    private final static String STORE_BASE_URL = "https://compstore.az/";


    public CompstoreAz(List<String> links){
        super("CompstoreAz");
    ...
    private Set<String> getProductImages(Document doc, String link) {
        ...
        for (Element srcLink : links) {
            ...
            hrefList.add(STORE_BASE_URL.concat(href));
        }

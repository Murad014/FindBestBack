...
public class UnimallAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.ty-price-num";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.ty-product-block-title";
    private final static String PRODUCT_PICTURE_KEY = "a.ty-previewer";



    public UnimallAz(List<String> links){
        super("UnimallAz");

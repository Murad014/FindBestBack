...
public class ProteinshopAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.sm_price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product_heading span";
    private final static String PRODUCT_PICTURE_KEY = "img.product_img";



    public ProteinshopAz(List<String> links){
        super("ProteinshopAz");

...
public class TimsportAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String DISCOUNT_PRICE_ELEMENT_KEY = "div.product__prices div.new span";
    private final static String PRICE_ELEMENT_KEY = "div.product__prices div.new span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product__title";
    private final static String PRODUCT_PICTURE_KEY = "meta[property=og:image]";



    public TimsportAz(List<String> links){
        super("TimsportAz");
    ...
    private String getPriceElement(Document doc, String link){
        ...
        return priceElement.text().replace("₼", "");
    }

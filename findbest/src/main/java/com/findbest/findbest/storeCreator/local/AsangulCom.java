...
public class AsangulCom extends LocalStore {

    private final static String BASE_URL = "https://asangul.com";
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.add2cart span.price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.name span";
    private final static String PRODUCT_PICTURE_KEY = "img#product-image";



    public AsangulCom(List<String> links){
        super("AsangulCom");

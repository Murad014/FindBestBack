...
public class DualAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.product-price-new";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.page-title span";
    private final static String PRODUCT_PICTURE_KEY = "div.swiper-container div div img";



    public DualAz(List<String> links){
        super("DualAz");
    ...
    private Set<String> getProductImages(Document doc, String link) {
        ...
        for (Element srcLink : links) {
            String href = srcLink.attr("data-largeimg");
            hrefList.add(href);
        }

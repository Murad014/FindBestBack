...
public class SaatStoreAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.us-price-actual";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.us-main-shop-title";
    private final static String PRODUCT_PICTURE_KEY = "img.img-fluid";



    public SaatStoreAz(List<String> links){
        super("SaatStoreAz");

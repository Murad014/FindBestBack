...
public class BookMartAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "p.price span.woocommerce-Price-amount bdi";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.summary-inner h1.product_title";
    private final static String PRODUCT_PICTURE_KEY = "div.product-image-wrap figure a img";



    public BookMartAz(List<String> links){
        super("BookMartAz");

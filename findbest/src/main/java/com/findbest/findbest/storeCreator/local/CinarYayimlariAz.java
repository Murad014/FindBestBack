...
public class CinarYayimlariAz extends LocalStore {

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.price-box span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.product__info__main h1";
    private final static String PRODUCT_PICTURE_KEY = "meta[property=og:image]";



    public CinarYayimlariAz(List<String> links){
        super("CinarYayimlariAz");

...
public class TekerStoreAz extends LocalStore{
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.price-current";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.title h1";
    private final static String PRODUCT_PICTURE_KEY = "img.img-responsive";



    public TekerStoreAz(List<String> links){
        super("TekerStoreAz");

...
public class LibraffAz extends LocalStore {
    ...
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1 bdi";
    private final static String PRODUCT_PICTURE_KEY = "a.cm-image-previewer";



    public LibraffAz(List<String> links){
        super("LibraffAz");

...
public class EvimizStoreAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span#price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.title";
    private final static String PRODUCT_PICTURE_KEY = "li img";



    public EvimizStoreAz(List<String> links){
        super("EvimizStoreAz");

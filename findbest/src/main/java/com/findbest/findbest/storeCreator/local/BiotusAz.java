...
public class BiotusAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span[data-price-type=finalPrice]";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "span.base";
    private final static String PRODUCT_PICTURE_KEY = "img.object-contain";



    public BiotusAz(List<String> links){
        super("BiotusAz");
    ...
    private Set<String> getProductImages(Document doc, String link) {
        ...
        for (Element srcLink : links) {
            String href = srcLink.attr("data-amsrc");
            if(!href.isEmpty())
                hrefList.add(href);
        }

...
public class AlininoAz extends LocalStore{

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = ".price span[itemprop=price]";
    private final static String PRODUCT_NAME_ELEMENT_KEY = ".product_title h1[itemprop=name]";
    private final static String PRODUCT_PICTURE_KEY = "#gallery";



    public AlininoAz(List<String> links){
        super("AlininoAz");

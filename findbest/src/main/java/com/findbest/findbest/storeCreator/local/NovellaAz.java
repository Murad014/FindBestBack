...
public class NovellaAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "ins span.amount";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product_title";
    private final static String PRODUCT_PICTURE_KEY = "img.wp-post-image";



    public NovellaAz(List<String> links){
        super("NovellaAz");

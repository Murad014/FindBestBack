...
public class SaralTechStore extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.price-new span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.title-product h1";
    private final static String PRODUCT_PICTURE_KEY = "img.mfp-img";



    public SaralTechStore(List<String> links){
        super("SaralTechStore");

...
public class TopBrandsAz extends LocalStore{
    private final static String BASE_URL = "https://topbrands.az/";
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.productDetailedPrice div.optionPrice";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.prodTitleBlock";
    private final static String PRODUCT_PICTURE_KEY = "a.123 span img";



    public TopBrandsAz(List<String> links){
        super("TopBrandsAz");

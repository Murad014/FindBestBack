...
public class HamisiburadaAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.details div.mb-3 span.h3";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.details h1.h3";
    private final static String PRODUCT_PICTURE_KEY = "div#image0 img";



    public HamisiburadaAz(List<String> links){
        super("HamisiburadaAz");

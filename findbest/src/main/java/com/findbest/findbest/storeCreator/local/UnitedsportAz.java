...
public class UnitedsportAz extends LocalStore {

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.regular-price span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.product-name h1";
    private final static String PRODUCT_PICTURE_KEY = "img#image-0";



    public UnitedsportAz(List<String> links){
        super("UnitedsportAz");

...
public class EmbawoodAz extends LocalStore {

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.price-block p span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h4.product__content-heading";
    private final static String PRODUCT_PICTURE_KEY = "img.image-product";



    public EmbawoodAz(List<String> links){
        super("EmbawoodAz");

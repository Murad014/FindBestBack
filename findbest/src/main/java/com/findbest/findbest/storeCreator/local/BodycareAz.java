...
public class BodycareAz extends LocalStore{

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "p.regular-price span";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.product-name h1";
    private final static String PRODUCT_PICTURE_KEY = "img.moreview_thumb_image";



    public BodycareAz(List<String> links){
        super("BodycareAz");

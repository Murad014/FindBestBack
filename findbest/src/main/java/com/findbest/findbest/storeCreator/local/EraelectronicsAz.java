...
public class EraelectronicsAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.price-main";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product-title";
    private final static String PRODUCT_PICTURE_KEY = "div.main-image a";



    public EraelectronicsAz(List<String> links){
        super("EraelectronicsAz");

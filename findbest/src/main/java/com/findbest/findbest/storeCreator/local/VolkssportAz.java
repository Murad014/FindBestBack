...
public class VolkssportAz extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.product-price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.page-title span";
    private final static String PRODUCT_PICTURE_KEY = "div.product-lmage-large a";



    public VolkssportAz(List<String> links){
        super("VolkssportAz");
    ...
    private Set<String> getProductImages(Document doc, String link) {
        ...
        for (Element srcLink : links) {
            String href = srcLink.attr("data-image-large-src");
            hrefList.add(href);
        }

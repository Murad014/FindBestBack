...
public class ButaliAz extends LocalStore{

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span[itemprop=price]";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1[itemprop=name]";
    private final static String PRODUCT_PICTURE_KEY = "div.product-cover img";



    public ButaliAz(List<String> links){
        super("ButaliAz");

...
public class DecoriaAZ extends LocalStore {
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "div.price-box span.product-price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "h1.product-title";
    private final static String PRODUCT_PICTURE_KEY = "div.owl-dot img";



    public DecoriaAZ(List<String> links){
        super("DecoriaAZ");

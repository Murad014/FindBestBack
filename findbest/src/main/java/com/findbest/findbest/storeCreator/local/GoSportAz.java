...
public class GoSportAz extends LocalStore{

    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "p.sku__price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.sku__heading h1";
    private final static String PRODUCT_PICTURE_KEY = "a.sku__slides-item";



    public GoSportAz(List<String> links){
        super("GoSportAz");

...
public class LifeSportAz extends LocalStore{
    private final List<String> links;
    private final List<StoreResponseDto> responseDtoList = new ArrayList<>();

    private final static String PRICE_ELEMENT_KEY = "span.radio_price";
    private final static String PRODUCT_NAME_ELEMENT_KEY = "div.title-product h1";
    private final static String PRODUCT_PICTURE_KEY = "div.large-image img";



    public LifeSportAz(List<String> links){
        super("LifeSportAz");
